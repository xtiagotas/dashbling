...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">DashBling<sup>2</sup></div>
            </a>
            ...
            {{-- <li class="nav-item">
                ...
                <div id="collapseVendas" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('notas.index')}}">Notas</a>
            ...
            {{-- <li class="nav-item">
                ...
                <div id="collapseProdutos" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item" href="{{route('produtos.index')}}">Notas</a>
                        <a class="collapse-item" href="{{route('produtos.index')}}">Pedidos</a>
                    </div>
                </div>
            </li> --}}
            ...
            <!-- Nav Item - Situacao -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('canais.index')}}">
    ...
    {{-- <script src="/js/demo/chart-pie-mkt.js"></script> --}}
